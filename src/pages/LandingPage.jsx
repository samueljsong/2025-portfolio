    ...
    return(
        <div className=" w-[100%]">
            <section className=" flex flex-col gap-4">
                ...
                <p className=" font-extralight text-xl text-primary squish max-md:text-[1.1rem]">I'm a problem solver who thrives on continuous learning and collaboration. Currently, I am working at Powerex as a full-stack developer (Co-op). Prior to that, I developed web solutions for both personal projects and client needs.</p>
